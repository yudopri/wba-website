...
<div class="container mx-auto p-6">
    <h1 class="text-2xl font-bold mb-6">Detail Invoice</h1>

    @php
    $pengaduan = 'Dikirim'; // Status saat ini
    $statusList = [
        ['label' => 'Dikirim', 'icon' => 'fas fa-file-alt'],
        ['label' => 'Dikonfirmasi', 'icon' => 'fas fa-cogs']
    ];
    @endphp
...
<div class="relative col-3 w-full max-w-4xl mx-auto mb-12">
    ...
    <div class="w-3/4 mx-auto">
        ...
        <div class="border-l-4 border-gray-300 pl-6 space-y-6">
            @php
            $history = [
                ['date' => '2020-03-31 20:35:37', 'Keterangan' => 'Invoice', 'person' => 'Fajar', 'Deskripsi' => 'Shipment to Atasan'],
                ['date' => '2020-03-31 19:56:18', 'Keterangan' => 'Invoice', 'person' => 'Joko', 'Deskripsi' => 'Approval'],
            ];
            @endphp
